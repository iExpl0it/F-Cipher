...
Good_Bye()
{
	...
	i=0
		...
		until [[ $i -eq 3 ]]
		do
			echo -e "${BRed}root@$User${BWhite}:${BBlue}~/$Current${White}# "; sleep 0.2
			 let i++
		done
		let i++
		let i++
		...
		while [[ $i -eq 6 && $i -le 7 ]]
		do
			echo -e "${BRed}root@$User${BWhite}:${BBlue}~/$Current${White}# ${Yellow}[${Red}*${Yellow}] All Credit Goes To: Ph4nt0m"; sleep 0.2; let i++
		done
		let i++
		while [[ $i -eq 8 && $i -le 10 ]]
		do
			echo -e "${BRed}root@$User${BWhite}:${BBlue}~/$Current${White}# ";sleep 0.2; let i++
		...
		do
			echo -e "${BRed}root@$User${BWhite}:${BBlue}~/$Current${White}# ${Yellow}[${Red}*${Yellow}] My Contact: Ethical.Hacker720@gmail.com"; sleep 0.3;let i++
		done
		
		let i++; let i++
		while [[ $i -gt 13 && $i -lt 16 ]]
		do
			echo -e "${BRed}root@$User${BWhite}:${BBlue}~/$Current${White}# ";sleep 0.2; let i++
		done
